...
public class Main extends Application {
	private final Node rootIcon = new ImageView(
			new Image(getClass().getResourceAsStream("/application/Java_Logo.png")));
	private final Image depIcon = new Image(getClass().getResourceAsStream("/application/Java_Logo.png"));
